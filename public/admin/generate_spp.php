    ...
    <div class="gen-layout">
      <div class="gen-left">
        ...
        <form method="POST" class="gen-form" autocomplete="off" id="genSingleForm">
          ...
          <div class="row">
            <label>NISN</label>
            <input type="text" name="nisn" id="nisnSingle" placeholder="Masukkan NISN" required />
          </div>
          <input type="hidden" name="csrf_token" value="<?= e(csrf_token()) ?>">
      ...
      <div class="gen-right">
        <div class="tip">Anda bisa memilih berdasarkan NISN.</div>
      </div>
    </div>
  </div>
